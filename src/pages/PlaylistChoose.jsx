...
import { View, ScrollView, StyleSheet, Text, FlatList, TouchableOpacity, TouchableHighlight, Image } from "react-native"
...
const DisplayPlaylist = ({ item, index, styles, dispatch, naviagtion, data, pos }) => {
    return (
        <TouchableHighlight
            onPress={() => {
                dispatch(addMusicinPlaylist({ id: index, music: data[pos] }));
                naviagtion.goBack()
            }}
            style={{
                borderRadius: 3
