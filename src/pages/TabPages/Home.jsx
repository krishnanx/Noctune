...
const RecommendationCard = ({ title, subtitle, bgColor,styles }) => (
      ...
      >
        ...
        <View style={[styles.section]}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => <QuickPickCard title={item.title} imageUrl={item.image} item = {item} handlePlay={handlePlay} styles={styles}/>}
